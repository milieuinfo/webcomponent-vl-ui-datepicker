  ...
  var datePickerclass = "js-".concat(vl.ns, "datepicker"),
    ...
    _createClass(Datepicker, [{
      ...
      value: function dress(datepicker) {
        ...
        var equalDates = function equalDates() {
          var newValue = e.target.value.split(fltpckr.l10n.rangeSeparator).join('');
        ...
        datepickerInput.addEventListener('change', function (e) {
          if (e.target.value && (!fltpckr.latestSelectedDateObj || !equalDates())) {
