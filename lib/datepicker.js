    ...
    _createClass(Datepicker, [{
      ...
      value: function dress(datepicker) {
        ...
        datepickerInput.addEventListener('change', function (e) {
          const equalDates = () => {
            const newValue = e.target.value.split(fltpckr.l10n.rangeSeparator).join('');
            const currentValue = fltpckr.selectedDates.map((date) => fltpckr.formatDate(date, datepickerDateFormat)).join('');
