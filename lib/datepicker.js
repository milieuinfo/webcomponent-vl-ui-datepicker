(function (global, factory) {
      ...
      ***************************************************************************** */
      ...
      function FlatpickrInstance(element, instanceConfig) {
        ...
        function onKeyDown(e) {
          ...
          // "Delete"     (IE "Del")           46
          var target = e.composedPath() ? e.composedPath()[0] || e.target : e.target;
          var isInput = target === self._input;
          ...
          if (e.keyCode === 13 && isInput) {
            if (allowInput) {
              self.setDate(self._input.value, true, target === self.altInput ? self.config.altFormat : self.config.dateFormat);
              return target.blur();
            } else {
              self.open();
            }
          } else if (isCalendarElem(target) || allowKeydown || allowInlineKeydown) {
            var isTimeObj = !!self.timeContainer && self.timeContainer.contains(target);
            ...
            switch (e.keyCode) {
              ...
              case 40:
                ...
                if (self.daysContainer && target.$i !== undefined || target === self.input) {
                  if (e.ctrlKey) {
                    e.stopPropagation();
              ...
              case 9:
                ...
                } else if (!self.config.noCalendar && self.daysContainer && self.daysContainer.contains(target) && e.shiftKey) {
                  e.preventDefault();
          ...
          if (self.amPM !== undefined && target === self.amPM) {
            switch (e.key) {
          ...
          if (isInput || isCalendarElem(target)) {
  ...
  var datePickerclass = "js-".concat(vl.ns, "datepicker"),
      datePickerInputclass = "".concat(datePickerclass, "-input"),
      datePickerToggleclass = "".concat(datePickerclass, "-toggle"),
      flatPickerMobileClass = 'flatpickr-mobile',
      datepickerData = "data-".concat(vl.ns, "datepicker"),
      datePickerDataFormat = "".concat(datepickerData, "-format"),
      datePickerDataVisualFormat = "".concat(datepickerData, "-visual-format"),
      datePickerDataMinDate = "".concat(datepickerData, "-min-date"),
      datePickerDataMaxDate = "".concat(datepickerData, "-max-date"),
      datePickerSelectedDate = "".concat(datepickerData, "-selected-date"),
      datePickerEnableTime = "".concat(datepickerData, "-enable-time"),
      datePickerDisableDate = "".concat(datepickerData, "-disable-date"),
      datePicker24hrTime = "".concat(datepickerData, "-24hr-time"),
      datePickerDataMinTime = "".concat(datepickerData, "-min-time"),
      datePickerDataMaxTime = "".concat(datepickerData, "-max-time"),
      datePickerDefaultTime = "".concat(datepickerData, "-default-time"),
      datePickerRange = "".concat(datepickerData, "-range");
    ...
    _createClass(Datepicker, [{
       ...
       * @return {false}
       */
      value: function dress(datepicker) {
        var datepickerInput = datepicker.querySelector(".".concat(datePickerInputclass)),
            datepickerButton = datepicker.querySelector(".".concat(datePickerToggleclass)),
        ...
        var settings = {
          ...
          'onChange': function onChange() {
            var event = vl.util.triggerEvent(datepicker, 'change');
          }
        };
        ...
        datepickerButton.addEventListener('keydown', function (e) {
          switch (e.keyCode) {
            case 13:
            case 32:
              fltpckr.open();
        ...
        var flatpickrMobile = datepicker.querySelector(".".concat(flatPickerMobileClass));
      ...
      value: function dressAll() {
        ...
        var datepickers = document.querySelectorAll(".".concat(datePickerclass, ":not([data-").concat(vl.ns, "js-dress=\"false\"]),\n      [").concat(datepickerData, "]:not([data-").concat(vl.ns, "js-dress=\"false\"])"));
        vl.util.each(datepickers, function (datepicker) {
          _this.dress(datepicker);
        });
      }
    }]);
